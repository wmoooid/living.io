                ...
                <ul className='section-innovation__grid-list'>
                    <li className='section-innovation__grid-item'>
                        ...
                        <div className='section-innovation__grid-description'>
                            <h4 className='section-innovation__description-heading'>Comfort & Space</h4>
                            <p className='section-innovation__description-text'>
                    ...
                    <li className='section-innovation__grid-item'>
                        ...
                        <div className='section-innovation__grid-description'>
                            <h4 className='section-innovation__description-heading'>Quality & Craftsmanship</h4>
                            <p className='section-innovation__description-text'>
                    ...
                    <li className='section-innovation__grid-item'>
                        ...
                        <div className='section-innovation__grid-description'>
                            <h4 className='section-innovation__description-heading'>Web3 Ownership</h4>
                            <p className='section-innovation__description-text'>
                    ...
                    <li className='section-innovation__grid-item'>
                        ...
                        <div className='section-innovation__grid-description'>
                            <h4 className='section-innovation__description-heading'>Price</h4>
                            <p className='section-innovation__description-text'>
